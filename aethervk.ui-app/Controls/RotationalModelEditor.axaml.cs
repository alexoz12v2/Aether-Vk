...
public partial class RotationalModelEditor : UserControl
{
  ...
  public static readonly StyledProperty<double> PoleRaDegProperty = AvaloniaProperty.Register<
    RotationalModelEditor,
    double
  >(nameof(PoleRaDeg), defaultValue: 90.0);

  public static readonly StyledProperty<double> PoleDecDegProperty = AvaloniaProperty.Register<
    RotationalModelEditor,
    double
  >(
    nameof(PoleDecDeg),
    defaultValue: 90.0 - AetherVk.Logic.ViewModels.IauRotationMath.ObliquityDeg
  );

  public static readonly StyledProperty<double> PrimeMeridianDegProperty =
    AvaloniaProperty.Register<RotationalModelEditor, double>(
      nameof(PrimeMeridianDeg),
      defaultValue: 180.0
    );

  public static readonly StyledProperty<double> PoleRaRateDegProperty = AvaloniaProperty.Register<
    RotationalModelEditor,
    double
  >(nameof(PoleRaRateDeg));

  public static readonly StyledProperty<double> PoleDecRateDegProperty = AvaloniaProperty.Register<
    RotationalModelEditor,
    double
  >(nameof(PoleDecRateDeg));

  public static readonly StyledProperty<double> RotationRateDegProperty = AvaloniaProperty.Register<
    RotationalModelEditor,
    double
  ...
  public static readonly StyledProperty<bool> IsEditableProperty = AvaloniaProperty.Register<
    RotationalModelEditor,
    bool
  >(nameof(IsEditable), defaultValue: true);
  ...
  public static readonly DirectProperty<RotationalModelEditor, float> QuatWProperty =
    AvaloniaProperty.RegisterDirect<RotationalModelEditor, float>(nameof(QuatW), o => o.QuatW);

  public static readonly DirectProperty<RotationalModelEditor, float> QuatXProperty =
    AvaloniaProperty.RegisterDirect<RotationalModelEditor, float>(nameof(QuatX), o => o.QuatX);

  public static readonly DirectProperty<RotationalModelEditor, float> QuatYProperty =
    AvaloniaProperty.RegisterDirect<RotationalModelEditor, float>(nameof(QuatY), o => o.QuatY);

  public static readonly DirectProperty<RotationalModelEditor, float> QuatZProperty =
    AvaloniaProperty.RegisterDirect<RotationalModelEditor, float>(nameof(QuatZ), o => o.QuatZ);
  ...
  protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
  {
    ...
    if (
      change.Property == PoleRaDegProperty
