...
public static class ActionContext
{
    public static readonly AttachedProperty<string> IdProperty = 
        AvaloniaProperty.RegisterAttached<Control, string>("Id", typeof(ActionContext));
    ...
    public static void SetHandler(Control element, IActionHandler? value) => element.SetValue(HandlerProperty, value);
