...
namespace aethervk.logic.tests
{
    ...
    public class HorizonJplServiceApiTests
    {
        private (HorizonJplService service, MockHttpMessageHandler handler) CreateService()
        {
            ...
            storageMock.Setup(s => s.GetPersistentPath(It.IsAny<string>())).Returns("dummy_persistent.txt");
        ...
        public async Task FetchPlanetOrbitDataAsync_GeneratesCorrectUrl()
        {
            ...
            await service.FetchPlanetOrbitDataAsync("90000033", "@10", new DateTime(2026, 5, 27), new DateTime(2026, 6, 27), "1d");
        ...
        public async Task DownloadSpkByIdAsync_GeneratesCorrectUrl()
        {
            ...
            await service.DownloadSpkByIdAsync("pdes", "90000033", "dummy.bsp", "2026-05-27", "2026-06-27");
