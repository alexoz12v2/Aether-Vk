...
public class TabDragTaskMessage
{
    ...
    public TabDragTaskMessage(TabItemViewModel draggedTab, Task<string> dragTask, IDragSourceView view)
    {
...
public class TabDroppedMessage
{
    ...
    public TabDroppedMessage(TabItemViewModel draggedTab, TabGroupNodeViewModel targetNode, DockZone zone, bool isCopy = false)
    {
        DraggedTab = draggedTab;
