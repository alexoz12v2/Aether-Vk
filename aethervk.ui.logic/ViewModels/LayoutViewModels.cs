...
public partial class TabGroupNodeViewModel : LayoutNodeViewModelBase
{
  ...
  private void ChangeSelectedTab(string tabType)
  {
    ...
    switch (tabType)
    {
      ...
      case "HorizonJpl":
        ...
        break;
      case "Outline":
        var outlineRuntimeService =
          ServiceLocator.Provider?.GetService(typeof(NativeRuntimeService)) as NativeRuntimeService;
        if (outlineRuntimeService != null)
          newTab = new OutlineViewModel(outlineRuntimeService);
        break;
      case "Properties":
        newTab = new PropertiesViewModel();
        break;
      case "DebugUI":
  ...
  private void AddNewOutlineTab()
  {
    ...
    {
      var newTab = new OutlineViewModel(runtimeService);
      Tabs.Add(newTab);
      SelectedTab = newTab;
    }
  }
