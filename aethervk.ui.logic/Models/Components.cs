...
public partial class TransformComponent : ObservableObject, IComponent
{
  ...
  [ObservableProperty] private float _rotW = 1.0f;

  [ObservableProperty] private float _rotX;

  [ObservableProperty] private float _rotY;

  [ObservableProperty] private float _rotZ;

  [ObservableProperty] private float _scaleX = 1.0f;

  [ObservableProperty] private float _scaleY = 1.0f;

  [ObservableProperty] private float _scaleZ = 1.0f;
}
...
public partial class CameraComponent : ObservableObject, IComponent
{
  ...
  [ObservableProperty] private float _fov = 45.0f;

  [ObservableProperty] private float _aspectRatio = 1.77f;

  [ObservableProperty] private float _nearPlane = 0.1f;

  [ObservableProperty] private float _farPlane = 10000.0f;

  [ObservableProperty] private float _orthoLeft = -10.0f;

  [ObservableProperty] private float _orthoRight = 10.0f;

  [ObservableProperty] private float _orthoBottom = -10.0f;

  [ObservableProperty] private float _orthoTop = 10.0f;

  [ObservableProperty] private bool _isOrthographic;

  [ObservableProperty] private bool _isActiveCamera;
...
public partial class SunComponent : ObservableObject, IComponent
{
  ...
  [ObservableProperty] private float _temperature = 5778.0f; // K

  [ObservableProperty] private bool _showBoundingBox = false;
}
...
public partial class PlanetComponent : ObservableObject, IComponent
{
  ...
  [ObservableProperty] private float _positionX = 150000000.0f;
  ...
  [ObservableProperty] private float _velocityY = 30.0f;

  [ObservableProperty] private float _velocityZ;

  [ObservableProperty] private bool _showBoundingBox;
}
...
public class BvhNodeVisibilityChangedMessage
{
  ...
  public BvhNodeVisibilityChangedMessage(ulong sceneId, ulong entityId, uint nodeIndex,
    bool isVisible)
  {
    SceneId = sceneId;
    EntityId = entityId;
...
{
  [ObservableProperty] private string _name = "New Jet";

  [ObservableProperty] private float _colorR = 1.0f;

  [ObservableProperty] private float _colorG = 0.0f;

  [ObservableProperty] private float _colorB = 0.0f;
  ...
  [ObservableProperty] private float _size = 5.0f;
}
...
public partial class CometComponent : ObservableObject, IComponent
{
  ...
  [ObservableProperty] private float _angularVelocityX = 0.1f;

  [ObservableProperty] private float _angularVelocityY = 0.2f;

  [ObservableProperty] private float _angularVelocityZ = 0.05f;
