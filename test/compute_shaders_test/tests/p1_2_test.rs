...
fn test_p1_2_imex_particles() {
  compute_shaders_test::ensure_test_data("test_data/p1_2.json", "gen_p1_2_data.py");
  ...
  let output_particles: Vec<f32> =
    ctx.read_buffer(buffer, &mut alloc, test_data.input_particles.len());
