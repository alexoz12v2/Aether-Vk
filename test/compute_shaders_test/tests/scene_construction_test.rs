...
fn test_scene_construction() {
    ...
    let uv_dist = aethervk_core_rlib::simulation::utils::generate_gaussian_distribution(64, 0.5, 0.5, 0.5, 0.5);
    ...
    println!("Successfully constructed a scene with a PhysicalMeshComponent (RigidBody) and a ParticleSystemComponent!");
}