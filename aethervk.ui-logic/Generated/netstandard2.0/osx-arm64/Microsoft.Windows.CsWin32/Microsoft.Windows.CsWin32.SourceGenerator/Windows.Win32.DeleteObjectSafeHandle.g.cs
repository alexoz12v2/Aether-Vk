...
namespace Windows.Win32
{
	...
	public partial class DeleteObjectSafeHandle
		:SafeHandle	{
		...
		public DeleteObjectSafeHandle(IntPtr preexistingHandle, bool ownsHandle = true):base(INVALID_HANDLE_VALUE, ownsHandle)
		{
		...
		protected override bool ReleaseHandle() => PInvoke.DeleteObject((winmdroot.Graphics.Gdi.HGDIOBJ)this.handle);
	}
}
